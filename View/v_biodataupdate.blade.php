...
@section('biodata')
<a class="btn btn-sm btn-primary" href="/biodata/updatebiodataform/{{ $biodata->id_biodata }}">Update Biodata</a>
<table class="table table-borderless">
    ...
    @endif
    <tr>
        <th width="270px">POSISI YANG DILAMAR</th>
        <th width="10px">:</th>
        <th>{{ $biodata->posisi }}</th>
    </tr>
    <tr>
