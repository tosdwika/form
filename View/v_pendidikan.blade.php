...
@section('biodata')
<div class="content">
<a class="btn btn-sm btn-primary" href="/biodata/pendidikan">Tambah Pendidikan</a>
    @if (session('pesan'))
            ...
            <div class="form-group">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <th class="col-sm-8">
                            <a class="btn btn-sm btn-warning" href="/biodata/updatependidikanform/{{ $data->id_pendidikan }}">Edit</a>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-primary">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="/biodata/deletependidikan/{{ $data->id_pendidikan }}" class="btn btn-sm btn-warning">Ya</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
