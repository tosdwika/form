...
@section('biodata')
<a class="btn btn-sm btn-primary" href="/biodataupdateadmin/{{ $id_biodata }}/pengalamanadmin/{{ $id }}/pengalaman">Tambah Pengalaman</a>
<div class="content">
    @if (session('pesan'))
            ...
            <div class="form-group">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <th class="col-sm-8">
                            <a class="btn btn-sm btn-warning" href="/biodataupdateadmin/{{ $biodata->id_biodata }}/pengalamanadmin/{{ $biodata->id }}/updatepengalamanformadmin/{{ $data->id_pengalaman }}">Edit</a>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-primary">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="/deletepengalamanadmin/{{ $data->id_pengalaman }}" class="btn btn-sm btn-warning">Ya</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
