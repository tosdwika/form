  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete{{ $data->id_biodata }}">
          Hapus
        </button>
      </td>
    </tr>
...
@foreach ($biodata as $data)
<div class="modal fade" id="delete{{ $data->id_biodata }}">
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="/allbiodata/delete/{{ $data->id_biodata }}" class="btn btn-sm btn-warning">Ya</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
