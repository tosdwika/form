...
@section('biodata')
<a class="btn btn-sm btn-primary" href="/biodata/pelatihan">Tambah Pelatihan</a>
<div class="content">
    @if (session('pesan'))
            ...
            <div class="form-group">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <th class="col-sm-8">
                            <a class="btn btn-sm btn-warning" href="/biodata/updatepelatihanform/{{ $data->id_pelatihan }}">Edit</a>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-primary">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="/biodata/deletepelatihan/{{ $data->id_pelatihan }}" class="btn btn-sm btn-warning">Ya</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
